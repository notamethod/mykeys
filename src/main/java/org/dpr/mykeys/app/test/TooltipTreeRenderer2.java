...
public class TooltipTreeRenderer2 extends DefaultTreeCellRenderer implements
	...
	public Component getTreeCellRendererComponent1(JTree tree, Object value,
			...
			boolean hasFocus) {
		JLabel defaut = (JLabel) super.getTreeCellRendererComponent(tree,
		...
		label.setBackground(isSelected ? getBackgroundSelectionColor()
				: getBackgroundNonSelectionColor());
		label.setForeground(isSelected ? getTextSelectionColor()
