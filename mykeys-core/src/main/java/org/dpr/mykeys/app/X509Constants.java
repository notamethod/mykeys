...
public class X509Constants {
	public static String[] keyUsageLabel = new String[] { "digitalSignature", "nonRepudiation", "keyEncipherment",
    ...
    public static int USAGE_CERTSIGN = 5;
    public static int USAGE_CRLSIGN = 6;
	public static int[] keyUsageInt = new int[] { KeyUsage.digitalSignature, KeyUsage.nonRepudiation,
